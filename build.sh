...
#   einzeldatei.html              → alles eingebettet (auch das PDF), zum Verschicken oder für Claude
cd "$(dirname "$0")" || exit 1
cp durbuy.html index.html
cp durbuy.html docs/index.html
cp Durbuy-Adressen.pdf docs/ 2>/dev/null   # das PDF, das beim Abschicken mitgeht
